    ...
    <>
      ...
      <div className="absolute top-4 right-4 z-20">
        <a
          ...
          className="border border-amber-500/30 bg-slate-900/80 rounded px-3 py-2 backdrop-blur-sm hover:bg-slate-800/90 hover:border-amber-500/50 transition-all duration-300 group flex items-center gap-2"
        >
          <svg
          ...
          <span className="text-amber-500/70 group-hover:text-amber-400 text-[10px] uppercase tracking-wider font-mono transition-colors">
            Code
          </span>
        </a>
      </div>
