                ...
                <div className="p-5 sm:p-8 clear-both">
                  ...
                  <div className="space-y-5 sm:space-y-6 text-slate-300 text-sm sm:text-base">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li><strong>Time:</strong> <button onClick={() => handleProofClick('case1')} className="inline text-left text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>The manual audit process took 120 minutes per day. With LogiScan, it takes about 20 minutes. That's an 83% reduction.</span><ExternalLink className="inline w-3 h-3 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" /></button> 100 minutes saved daily.</li>
                        ...
                        <li><strong>Cost:</strong> <button onClick={() => handleProofClick('case3')} className="inline text-left text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>The image compression optimization reduced Vision API costs by roughly 90%. A 10MB photo compresses to 500KB before upload.</span><ExternalLink className="inline w-3 h-3 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" /></button> The client-side matching eliminated 50 to 100 database queries per audit session.</li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="leading-relaxed mb-3">
                        <button onClick={() => handleProofClick('case6')} className="inline text-left text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>The trade-off is cost and speed. GPT-4o Vision costs more per image and takes 3-5 seconds to process. But the accuracy gain and development time savings made it worth it. I'd rather pay $0.02 per scan and get clean data than spend weeks building a custom OCR pipeline.</span><ExternalLink className="inline w-3 h-3 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" /></button> I'd rather pay $0.02 per scan and get clean data than spend weeks building a custom OCR pipeline.
                      </p>

                      <h4 className="font-bold mt-4 mb-2">Why PWA instead of a native app?</h4>
                      <p className="leading-relaxed">
                        This hybrid approach gives you the best of both worlds. You get the intelligence of an LLM without the latency of doing everything server-side. <button onClick={() => handleProofClick('case5')} className="inline text-left text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>The flow: User takes photo → Compress (Canvas API: 10MB → 500KB) → Upload compressed image → Next.js Server sends to GPT-4o Vision → Extract structured JSON → Return to Client → Client-Side Matching (in-memory, &lt;10ms) → Display Results. This eliminates 50-100 database queries per audit session.</span><ExternalLink className="inline w-3 h-3 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" /></button>
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      <p className="leading-relaxed mb-3">
                        The trade-off is cost and speed. <button onClick={() => handleProofClick('case6')} className="inline text-left text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>GPT-4o Vision costs more per image and takes 3-5 seconds to process. But the accuracy gain and development time savings made it worth it. I'd rather pay $0.02 per scan and get clean data than spend weeks building a custom OCR pipeline.</span><ExternalLink className="inline w-3 h-3 ml-1 opacity-60 group-hover:opacity-100 transition-opacity" /></button>
                      </p>
                      <p className="leading-relaxed">
