                  ...
                  <div className="space-y-5 sm:space-y-6 text-slate-300 text-sm sm:text-base">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2 ml-4 list-disc">
                        <li><strong>Network Layer:</strong> <button onClick={() => handleProofClick('case3-exponential-backoff')} className="inline-flex items-center gap-1 text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>Exponential backoff retry logic.</span><ExternalLink className="w-3 h-3 opacity-60 group-hover:opacity-100 transition-opacity" /></button> If a request to N8N fails, wait 1 second and retry. If that fails, wait 2 seconds. Then 4 seconds. After three failures, surface a user-facing error. This handles temporary network hiccups without bothering the user.</li>
                    ...
                    <div>
                      ...
                      <p className="leading-relaxed mb-3">
                        <strong>Latency:</strong> <button onClick={() => handleProofClick('case6-interaction-speed')} className="inline-flex items-center gap-1 text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>From the moment recording stops to the moment audio playback begins averages 1.8 seconds.</span><ExternalLink className="w-3 h-3 opacity-60 group-hover:opacity-100 transition-opacity" /></button> This breaks down as: Network upload (WAV file) ~200ms, Whisper transcription ~400ms, GPT-4o reasoning ~800ms, TTS generation ~300ms, Network download (audio blob) ~100ms, Audio decode + playback start ~200ms.
                      </p>
                    ...
                    <div>
                      ...
                      <ul className="space-y-3 ml-4 list-disc">
                        <li><strong>Voice interfaces need to show what they're thinking:</strong> <button onClick={() => handleProofClick('case8-end-to-end-latency')} className="inline-flex items-center gap-1 text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>Silent processing feels broken.</span><ExternalLink className="w-3 h-3 opacity-60 group-hover:opacity-100 transition-opacity" /></button> Users need constant feedback about what state the system is in. Live transcription during recording, visual spinners during processing, and synchronized text during playback all contribute to the perception of responsiveness.</li>
                    ...
                    <div>
                      ...
                      <p className="leading-relaxed mb-3">
                        <button onClick={() => handleProofClick('case4-decoupled-architecture')} className="inline-flex items-center gap-1 text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>Separation of concerns.</span><ExternalLink className="w-3 h-3 opacity-60 group-hover:opacity-100 transition-opacity" /></button> The frontend handles user interaction and audio processing. N8N handles AI orchestration. This means I can modify the AI pipeline (swap GPT-4o for Claude, add RAG lookups, change TTS providers) without touching the frontend.
                      </p>
                ...
                <div className="p-5 sm:p-8 clear-both">
                  ...
                  <div className="space-y-5 sm:space-y-6 text-slate-300 text-sm sm:text-base">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        <li><strong>Time:</strong> <button onClick={() => handleProofClick('case1')} className="inline-flex items-center gap-1 text-amber-400 hover:text-amber-300 underline decoration-amber-500/30 hover:decoration-amber-400/60 transition-all cursor-pointer hover:gap-1.5 group"><span>The manual audit process took 120 minutes per day. With LogiScan, it takes about 20 minutes. That's an 83% reduction.</span><ExternalLink className="w-3 h-3 opacity-60 group-hover:opacity-100 transition-opacity" /></button> 100 minutes saved daily.</li>
