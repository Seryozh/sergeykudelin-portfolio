        ...
        <div className="group relative inline-block">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-xs text-blue-400 font-semibold uppercase tracking-wider">Live Demo</p>
              <p className="text-white font-medium text-lg">DoorLoop Voice Agent</p>
            </div>
