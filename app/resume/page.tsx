    ...
    <>
      <style>{`
        @media print {
          ...
          .resume-page {
            padding: 0.22in 0.42in !important;
      ...
      <div
        className="resume-page max-w-[8.5in] mx-auto bg-white text-slate-900 px-10 py-8 min-h-screen mt-14 print:mt-0"
        style={{ fontFamily: "'Inter', 'Segoe UI', system-ui, sans-serif", lineHeight: 1.38 }}
      >

        {/* ── Header ── */}
        <header className="mb-4">
          <h1 className="text-[26px] font-black tracking-tight text-slate-900 leading-none">SERGEY KUDELIN</h1>
          <p className="text-[11.5px] font-medium text-slate-500 mt-1 tracking-wide">
        ...
        <section className="mb-4">
          ...
          <div className="mb-2.5 pl-3 border-l-[3px] border-slate-300">
            <div className="flex items-baseline justify-between gap-2">
              <h3 className="text-[12px] font-bold text-slate-900">Creator &amp; Growth Researcher &nbsp;|&nbsp; @SergeCode, YouTube</h3>
          ...
          <div className="pl-3 border-l-[3px] border-slate-300">
            <div className="flex items-baseline justify-between gap-2">
              <h3 className="text-[12px] font-bold text-slate-900">Operations &amp; Concierge &nbsp;|&nbsp; Tides Condo, Hollywood FL</h3>
        ...
        <section>
          ...
          <div className="flex items-baseline justify-between gap-2">
            <h3 className="text-[11.5px] font-bold text-slate-900">Florida International University &nbsp;—&nbsp; Computer Science</h3>
